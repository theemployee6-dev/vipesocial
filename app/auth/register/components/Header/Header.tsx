  ...
  return (
    <div className="text-center mb-8 md:mb-6 lg:mb-8 xl:mb-8 2xl:mb-16 4k:mb-16 fade-up">
      <div className="inline-flex items-center gap-2 mb-4 md:mb-2 lg:mb-2 xl:mb-2 2xl:mb-8 4k:mb-10">
        <div className="w-[250] sm:w-[280] md:w-[300] lg:w-[320] xl:w-[340] 2xl:w-[380] 4k:w-[400]">
          <Logo />
        </div>
      </div>
      ...
      <div className="space-y-1 md:space-y-2">
        ...
        <h1 className="Poppins text-white text-2xl sm:text-3xl md:text-xl lg:text-5xl xl:text-4xl 2xl:text-7xl 4k:text-8xl font-bold leading-tight">
          {secondBigTitleWhite}
