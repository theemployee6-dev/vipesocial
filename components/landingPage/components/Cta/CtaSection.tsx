  ...
  return (
    <section className="bg-(--bg) py-2 px-4 text-center relative overflow-hidden md:py-20 md:px-6 4k:py-45 4k:px-10">
      ...
      <div className="max-w-full mx-auto relative md:max-w-[1100]">
        ...
        <div>
          <button className="bg-(--green) text-[#04070e] border-none px-7 py-3.5 rounded-full font-extrabold text-sm cursor-pointer transition-all duration-300 shadow-[0_0_40px_rgba(0,255,136,0.2)] relative whitespace-nowrap w-auto max-w-full hover:bg-[#00ffaa] hover:-translate-y-1 hover:shadow-[0_0_60px_rgba(0,255,136,0.3)] md:px-10 md:py-[18px] md:text-base md:shadow-[0_0_60px_rgba(0,255,136,0.3)] 4k:px-15 4k:py-6 4k:text-xl">
